...
e_MergedMeshesLodRatio=1;--------------------------system 1
e_MergedMeshesInstanceDist=2;--------------------------system 1 changed to 2
...
e_LodRatio=50;--------------------------default 25 changed to 50
e_VegetationMinSize=0;--------------------------default 0
e_OcclusionCullingViewDistRatio=1;--------------------------default 1
e_ViewDistMin=0;--------------------------default 5 changed to 0
...
r_DrawNearZRange=0.12;--------------------------default 0.001 changed to 0.12
...
e_UberlodDistanceRatio=3;--------------------------default 3
